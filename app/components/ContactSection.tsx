		...
		<section className="py-20 px-4">
			<div className="max-w-4xl mx-auto text-center">
				<motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="space-y-8">
					<h2 className="text-3xl font-bold">Let&apos;s Turn Your Data into Actionable Insights</h2>
					<p className="text-gray-400 max-w-2xl mx-auto">
						Looking for a data engineer who can build robust pipelines and transform raw data into valuable business intelligence? Let&apos;s discuss your project.
					</p>
					...
					<div className="flex justify-center gap-6">
						<a
							href="https://github.com/walter-ryan"
							target="_blank"
						...
						<a
							href="https://www.linkedin.com/in/walterryan/"
							target="_blank"
							rel="noopener noreferrer"
							className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-gray-800 rounded-lg"
						>
