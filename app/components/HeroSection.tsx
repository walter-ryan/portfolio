...
export default function HeroSection() {
	...
	return (
		<section className="min-h-screen relative overflow-hidden py-24 md:py-0">
			<motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="absolute inset-0">
				...
				<motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-8 md:mb-12">
					<div className="space-y-3 md:space-y-4 mb-6 md:mb-8">
						...
						<p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto">
							I build data-intensive backend Cloud applications.
						</p>
						<p className="text-base md:text-lg text-gray-500 max-w-2xl mx-auto">
							Data Engineer and Software Developer at <span className="text-green-600">Lloyds Banking Group</span>
						</p>
					</div>
					<div className="flex flex-wrap justify-center gap-2 md:gap-3 mb-6 md:mb-8">
						<span className="px-3 md:px-4 py-1.5 md:py-2 bg-blue-500/10 rounded-full text-blue-400 text-xs md:text-sm">Java & Spring</span>
						<span className="px-3 md:px-4 py-1.5 md:py-2 bg-purple-500/10 rounded-full text-purple-400 text-xs md:text-sm">Python</span>
						<span className="px-3 md:px-4 py-1.5 md:py-2 bg-teal-500/10 rounded-full text-teal-400 text-xs md:text-sm">Google Cloud</span>
						<span className="px-3 md:px-4 py-1.5 md:py-2 bg-blue-500/10 rounded-full text-blue-400 text-xs md:text-sm">DBT</span>
					</div>
				</motion.div>
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
							...
							>
								...
								<ul className="space-y-1.5 md:space-y-2 text-xs md:text-sm text-gray-400">
									...
									<li className="flex items-center gap-2">
										<div className="w-1.5 h-1.5 bg-teal-500 rounded-full" />
										CI/CD Pipelines via Jenkins, Spinnaker and Harness
									</li>
									<li className="flex items-center gap-2">
										<div className="w-1.5 h-1.5 bg-teal-500 rounded-full" />
